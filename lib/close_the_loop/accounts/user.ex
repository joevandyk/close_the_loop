defmodule CloseTheLoop.Accounts.User do
  use Ash.Resource,
  ...
  authentication do
    add_ons do
      ...
      confirmation :confirm_new_user do
        ...
        sender CloseTheLoop.Accounts.User.Senders.SendNewUserConfirmationEmail
      end
    end

    tokens do
      enabled? true
      token_resource CloseTheLoop.Accounts.Token
      signing_secret CloseTheLoop.Secrets
    ...
    strategies do
      magic_link do
        ...
        sender CloseTheLoop.Accounts.User.Senders.SendMagicLinkEmail
      end
      ...
      password :password do
        ...
        resettable do
          sender CloseTheLoop.Accounts.User.Senders.SendPasswordResetEmail
